package com.employee.shared.dto;
...
public class UserDTO implements Serializable {
	...
	public String getEmailVerfToken() {
		return emailVerfToken;
	}

	public void setEmailVerfToken(String emailVerfToken) {
		this.emailVerfToken = emailVerfToken;
	}
